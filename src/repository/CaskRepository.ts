 ...
 * @returns The most installed casks of the last 30 days
 */
export async function getTopInstall30CasksFromDB(take: number): Promise<Cask[]> {
 ...
 * @returns The most installed casks of the last 90 days
 */
export async function getTopInstall90CasksFromDB(take: number): Promise<Cask[]> {
    return prisma.cask.findMany({
        orderBy: {
            install90: 'desc'
        },
 ...
 * @returns The most installed casks of the last 365 days
 */
export async function getTopInstall365CasksFromDB(take: number): Promise<Cask[]> {
    return prisma.cask.findMany({
        orderBy: {
            install365: 'desc'
        },
